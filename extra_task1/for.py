...
# Стратегии OpenMP в вашей программе
strategies = ["static,  1", "static,  4", "dynamic, 1", "dynamic, 4", "guided", "default"]

# Количество повторов для усреднения
num_runs = 1000

# Словарь для хранения результатов: {strategy: [среднее время по потокам]}
...
for threads in thread_counts:
    ...
    # Временные списки для накопления результатов повторов
    ...
    # Усредняем по количеству повторов
    for s in strategies:
